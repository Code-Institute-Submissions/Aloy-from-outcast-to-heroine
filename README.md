...
## Wireframing: ##
---
For wireframing I used [Pencil Prototyping](https://pencil.evolus.vn/). This produced some very basis wireframes, used to get an overall 'feel' for what would go where and how things would look on different screensizes.
